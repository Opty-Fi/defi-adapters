...
// export function shouldStakeLikeBeefyFinanceAdapter(token: string, pool: PoolItem): void {
...
//     const actualRewardToken = await this.beefyFinanceAdapter.getRewardToken(pool.beefyVault);
...
//       await this.beefyFinanceAdapter.getRewardToken(pool.beefyVault),
//       this.testDeFiAdapter.address,
//     );
...
//     // expect(await this.testDeFiAdapter.getERC20TokenBalance(pool.wantToken, this.testDeFiAdapter.address)).to.be.gt(0);
